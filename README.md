...
*ContentApi* | [**uploadResource**](docs/Api/ContentApi.md#uploadresource) | **POST** /sites/multiscreen/resources/{site_name}/upload | Upload a resource to the website from an external source. Resource is uploaded to Duda&#39;s CDN and made available to anyone building the website.
...
- [ActivityResultsInner](docs/Model/ActivityResultsInner.md)
...
- [CollectionValuesInner](docs/Model/CollectionValuesInner.md)
...
- [InjectedContentCreation](docs/Model/InjectedContentCreation.md)
- [InjectedContentCreationAllOf](docs/Model/InjectedContentCreationAllOf.md)
...
- [LocationBusinessHoursInner](docs/Model/LocationBusinessHoursInner.md)
- [LocationEmailsInner](docs/Model/LocationEmailsInner.md)
- [LocationGeo](docs/Model/LocationGeo.md)
- [LocationPhonesInner](docs/Model/LocationPhonesInner.md)
...
- [SiteCreation](docs/Model/SiteCreation.md)
...
- [SiteUpdate](docs/Model/SiteUpdate.md)
