...
class AnalyticsResponseInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('unique_visitors', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($unique_visitors)) {
            throw new \InvalidArgumentException('non-nullable unique_visitors cannot be null');
        }
    ...
    public function setPageViews($page_views)
    {
        if (is_null($page_views)) {
            throw new \InvalidArgumentException('non-nullable page_views cannot be null');
        }
