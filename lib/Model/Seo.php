...
class Seo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('no_index', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['no_index'];
    }

    /**
     * Sets no_index
     *
     * @param bool|null $no_index no_index
     *
     * @return self
     */
    public function setNoIndex($no_index)
    {
        ...
        if (is_null($no_index)) {
            throw new \InvalidArgumentException('non-nullable no_index cannot be null');
        }

        $this->container['no_index'] = $no_index;
     ...
     * Sets og_image
     *
     * @param string|null $og_image og_image
     *
     * @return self
     */
