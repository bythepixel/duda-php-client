...
/**
    ...
    public function createFromSiteRequest($create_template_from_site_request, string $contentType = self::contentTypes['createFromSite'][0])
    {
        ...
        if (isset($create_template_from_site_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                ...
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($create_template_from_site_request));
            } else {
    ...
    public function createFromTemplateRequest($create_template_from_template_request, string $contentType = self::contentTypes['createFromTemplate'][0])
    {
        ...
        if (isset($create_template_from_template_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($create_template_from_template_request));
            } else {
