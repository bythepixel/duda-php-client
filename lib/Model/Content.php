...
class Content implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('additional_locations', $data ?? [], null);
        $this->setIfExists('site_texts', $data ?? [], null);
        $this->setIfExists('business_data', $data ?? [], null);
        $this->setIfExists('site_images', $data ?? [], null);
    }
    ...
    */
    ...
    public function setAdditionalLocations($additional_locations)
    {
        ...
        if (is_null($additional_locations)) {
            throw new \InvalidArgumentException('non-nullable additional_locations cannot be null');
        }
    ...
    public function setSiteTexts($site_texts)
    {
        ...
        if (is_null($site_texts)) {
            throw new \InvalidArgumentException('non-nullable site_texts cannot be null');
        }
    ...
    public function setSiteImages($site_images)
    {
        ...
        if (is_null($site_images)) {
            throw new \InvalidArgumentException('non-nullable site_images cannot be null');
        }
