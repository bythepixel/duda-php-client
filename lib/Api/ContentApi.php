...
class ContentApi
{
     ...
     * @return void
     */
    public function createInjectedContent($site_name, $injected_content_creation = null)
    {
        $this->createInjectedContentWithHttpInfo($site_name, $injected_content_creation);
    }
     ...
     */
    public function createInjectedContentWithHttpInfo($site_name, $injected_content_creation = null)
    {
        $request = $this->createInjectedContentRequest($site_name, $injected_content_creation);
     ...
     */
    public function createInjectedContentAsync($site_name, $injected_content_creation = null)
    {
        return $this->createInjectedContentAsyncWithHttpInfo($site_name, $injected_content_creation)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createInjectedContentAsyncWithHttpInfo($site_name, $injected_content_creation = null)
    {
        $returnType = '';
        $request = $this->createInjectedContentRequest($site_name, $injected_content_creation);
     ...
     */
    public function createInjectedContentRequest($site_name, $injected_content_creation = null)
    {
     ...
     * @return void
     */
    public function createInjectedContentSinglePage($site_name, $page_name, $injected_content_creation = null)
    {
        $this->createInjectedContentSinglePageWithHttpInfo($site_name, $page_name, $injected_content_creation);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function createInjectedContentSinglePageWithHttpInfo($site_name, $page_name, $injected_content_creation = null)
    {
        $request = $this->createInjectedContentSinglePageRequest($site_name, $page_name, $injected_content_creation);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createInjectedContentSinglePageAsync($site_name, $page_name, $injected_content_creation = null)
    {
        return $this->createInjectedContentSinglePageAsyncWithHttpInfo($site_name, $page_name, $injected_content_creation)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createInjectedContentSinglePageAsyncWithHttpInfo($site_name, $page_name, $injected_content_creation = null)
    {
        $returnType = '';
        $request = $this->createInjectedContentSinglePageRequest($site_name, $page_name, $injected_content_creation);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function createInjectedContentSinglePageRequest($site_name, $page_name, $injected_content_creation = null)
    {
        // verify the required parameter 'site_name' is set
        if ($site_name === null || (is_array($site_name) && count($site_name) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return void
     */
    public function updateContentLibrary($site_name, $content = null)
    {
        $this->updateContentLibraryWithHttpInfo($site_name, $content);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateContentLibraryWithHttpInfo($site_name, $content = null)
    {
        $request = $this->updateContentLibraryRequest($site_name, $content);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateContentLibraryAsync($site_name, $content = null)
    {
        return $this->updateContentLibraryAsyncWithHttpInfo($site_name, $content)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateContentLibraryAsyncWithHttpInfo($site_name, $content = null)
    {
        $returnType = '';
        $request = $this->updateContentLibraryRequest($site_name, $content);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateContentLibraryRequest($site_name, $content = null)
    {
        // verify the required parameter 'site_name' is set
        if ($site_name === null || (is_array($site_name) && count($site_name) === 0)) {
            throw new \InvalidArgumentException(
     ...
     */
    public function uploadResource($site_name, $resource = null)
    {
        list($response) = $this->uploadResourceWithHttpInfo($site_name, $resource);
        return $response;
    }
     ...
     */
    public function uploadResourceWithHttpInfo($site_name, $resource = null)
    {
        $request = $this->uploadResourceRequest($site_name, $resource);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function uploadResourceAsync($site_name, $resource = null)
    {
        return $this->uploadResourceAsyncWithHttpInfo($site_name, $resource)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function uploadResourceAsyncWithHttpInfo($site_name, $resource = null)
    {
        $returnType = '\OpenAPI\Client\Model\UploadResourceResponse';
        $request = $this->uploadResourceRequest($site_name, $resource);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function uploadResourceRequest($site_name, $resource = null)
    {
        // verify the required parameter 'site_name' is set
        if ($site_name === null || (is_array($site_name) && count($site_name) === 0)) {
            throw new \InvalidArgumentException(
